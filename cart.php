...
if (isset($_GET['delete'])) {
    ...
    pg_query($conn, "DELETE FROM cart WHERE id = '$delete_id'") or die('query failed');
...
if (isset($_POST['update_quantity'])) {
    ...
    pg_query($conn, "UPDATE cart SET quantity = '$cart_quantity' WHERE id = '$cart_id'") or die('query failed');

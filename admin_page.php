   ...
   <section class="dashboard">
      ...
      <div class="box-container">
         ...
         <div class="box">
            <?php
            $total_pendings = 0;
            $select_pendings = pg_query($conn, "SELECT * FROM orders WHERE payment_status = 'pending'") or die('query failed');
         ...
         <div class="box">
            <?php
            $total_completes = 0;
            $select_completes = pg_query($conn, "SELECT * FROM orders WHERE payment_status = 'completed'") or die('query failed');
            while ($fetch_completes = pg_fetch_assoc($select_completes)) {

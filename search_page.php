...
if (isset($_POST['add_to_wishlist'])) {
    ...
    if (pg_num_rows($check_wishlist_numbers) > 0) {
        ...
        pg_query($conn, "INSERT INTO wishlist(user_id, pid, name, price, image) VALUES('$user_id', '$product_id', '$product_name', '$product_price', '$product_image')") or die('query failed');

...
if (isset($_POST['update_order'])) {
   ...
   $update_payment = pg_escape_string($conn, $_POST['update_payment']);
   pg_query($conn, "UPDATE orders SET payment_status = '$update_payment' WHERE id = '$order_id'") or die('query failed');
   $message[] = 'payment status has been updated!';
}

if (isset($_GET['delete'])) {
   $delete_id = $_GET['delete'];
   pg_query($conn, "DELETE FROM orders WHERE id = '$delete_id'") or die('query failed');
